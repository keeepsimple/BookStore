namespace BookStore.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("Common.BookAuthor", "AuthorId", "common.Authors");
            DropForeignKey("Common.BookAuthor", "BookId", "common.Books");
            DropIndex("Common.BookAuthor", new[] { "AuthorId" });
            DropIndex("Common.BookAuthor", new[] { "BookId" });
